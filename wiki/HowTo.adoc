...
[source]
                     0,20(mt) x  2*PiGreco (radianti) 
Vtangenziale =      --------------------------------=  circa 232,6 m/s
                      0,0054(s)
                      
*Per cui l'estremità del nostro disco da taglio avrà una velocità tangenziale di _232,6_ m/s al numero di RPM massimi con batteria completamente carica.* Essendo la velocità del suono pari a 343 m/s,  siamo sotto alla velocità del suono.
